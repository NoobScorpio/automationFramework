...
class TestBingSearchTDDSuite(TestBase):
    ...
    def test_search_tdd(self, driver, env):
        """
        :param driver:
        :return:
        """
        self.log.info(f"test_bing_search_tdd tested by {self.tester} on {env} environment")
        ...
        for row in range(2, rows + 1):
            ...
            driver.get(k.BingGlossary.Bing_URL_DEV)
